...
urlpatterns = [
    ...
    path("admin-panel/client-display", views.client_display_settings_save, name="client_display_settings_save"),
    path("client-display/toggle", views.client_display_toggle, name="client_display_toggle"),
    path("tv", views.tv_display, name="tv_display"),
    path("tv/state", views.tv_display_state, name="tv_display_state"),
    path("tv/mirror.jpg", views.tv_mirror_frame, name="tv_mirror_frame"),
