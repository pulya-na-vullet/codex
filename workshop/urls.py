...
urlpatterns = [
    ...
    path("products", views.products_shelf, name="products"),
    path("products/<slug:slug>", views.product_deck, name="product_deck"),
    path("products/<slug:slug>/<slug:page>", views.product_deck, name="product_page"),
